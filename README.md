...
Агент тестировался на OpenAI GPT-5-mini и GPT-5, где так же показал стабильную работу.
...
после установки выполнить команду в командной строке
```bash
semgrep login
```
...
Агент иногда капризничает и получился чувствительным к путям до файлов, предпочтительно использовать абсолютные пути.
