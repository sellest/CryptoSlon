...
class QueryPreprocessor:
    def __init__(self, template_name: str = "queryprep", llm: str = "gigachat"):
        self.llm_client = get_llm_client(llm)
        self.template_name = template_name
        self.template = self._load_template(template_name)
        self.logger = logging.getLogger(__name__)

    @staticmethod
    def _load_template(template: str = "queryprep") -> Dict[str, Any]:
    ...
    @staticmethod
    def _detect_language_simple(query: str) -> str:
    ...
    @staticmethod
    def _extract_entities_regex(query: str) -> List[str]:
